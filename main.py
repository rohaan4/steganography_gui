...
Button(frame3, text="Open Image", width=10, height=2, font="ariel 14 bold").place(x=20, y=30)#making a button in the third frame to open the image
Button(frame3, text="Save Image", width=10, height=2, font="ariel 14 bold").place(x=180, y=30)#making another button to save the image
...
Button(frame4, text="Encode Data", width=10, height=2, font="ariel 14 bold").place(x=20, y=30)#creating button in the fourth frame to encode data in image
Button(frame4, text="Decode Data", width=10, height=2, font="ariel 14 bold").place(x=180, y=30)#creating another button to decode data in the image
